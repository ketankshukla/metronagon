...
> - Box set front cover
> - 10 keyword-optimized Amazon book descriptions
...
>
> Ready to get started? I'll send the creative brief.
...
> - 2 revision rounds covering everything
>
> It's genuinely all-inclusive. The only thing not included is rush delivery (+50% if you need it in 48 hours, but the standard 4-day turnaround is fast enough for most launches).
...
> - **Stage 2 (Day 3):** Books 4-7 covers + descriptions
> - **Stage 3 (Day 4):** Books 8-10 covers + descriptions + box set cover
>
> You can start uploading to KDP as each stage arrives. The revision rounds apply across all stages — you can give feedback on Stage 1 while I'm building Stage 2, or hold all feedback until the end.
>
> Want to proceed with staged delivery?
...
> - Target audience — Who is your ideal reader? Comparable authors/series?
...
> - Description tone:
> - Spoiler boundaries — What should NOT be revealed in descriptions?
...
>
> **Tip:** If you only have detailed info for some books, that's fine. Give me what you have. For the rest, even a working title + one sentence about the focus is enough. I'll design and write around what exists and you can refine later.
...
> - Book 10: [Climactic visual — distinct but unified]
>
...
> - Comp authors referenced in Books 1 and 5 (entry points for new readers)
> - Each description stands alone (reader can start at Book 1 or discover mid-series)
> - Spoiler discipline: Each description only references events from prior books, never ahead
>
> I'll deliver everything within 4 business days. Starting now!
...
>
> Take your time. This is a big delivery and it's worth reviewing carefully.
...
> - Book 8: Too many spoilers from Book 7. Dial back.
> - Book 9: The ending CTA should reference the finale (Book 10), not just "continue the series"
> - All others: Perfect
...
>
> The more specific you are, the closer I'll land in one pass. Round 2 is still available for fine-tuning after this.
...
> - Book 2: "How far would you follow someone you can't trust?"
> - [etc. — each one unique, genre-appropriate, emotionally resonant]
>
> Same keywords, same genre positioning, same spoiler discipline — just a different structural approach.
>
> This uses Revision Round 1. Round 2 available for further fine-tuning.
...
>
> Round 2 of 2. I'll apply these plus a final quality pass across all 22 deliverables and prepare your files.
...
> 4. Upload box set cover for your Amazon box set listing
> 5. View all 10 covers side by side at thumbnail size before going live
> 6. Read each description one final time before publishing
>
> **Important — I recommend a soft launch:**
> Publish Books 1-3 first. Monitor reviews and sales data. Then release the remaining books on a cadence that builds momentum (weekly or biweekly releases work well for Amazon's algorithm).
>
> This has been an extraordinary project. A 10-book series with full visual and verbal identity is a serious accomplishment. A Reedsy review would mean the world to me — and returning clients always get 10% off!
...
> - Box Set 4: Complete (already delivered)
>
> All designed within the existing visual system. 1 business day per box set.
...
>
> Send me the new brief whenever you're ready!
...
> - **Series overview banner** (landscape format for Facebook/Twitter headers)
> - **Quote graphics** (book quotes over cover art)
> - **Release countdown graphics**
>
> Contact me at hello@metronagon.com and I'll put together a custom quote based on what you need. As a returning client, you'll get 10% off.
