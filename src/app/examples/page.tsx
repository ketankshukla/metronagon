...
const childrensData = {
  pictureBooks: {
    ...
    images: [
      { src: "/portfolio/childrens/front-cover.jpg", title: "Front Cover" },
      { src: "/portfolio/childrens/page-02.jpg", title: "Page 2" },
      { src: "/portfolio/childrens/page-03.jpg", title: "Page 3" },
      { src: "/portfolio/childrens/page-04.jpg", title: "Page 4" },
      { src: "/portfolio/childrens/page-05.jpg", title: "Page 5" },
      { src: "/portfolio/childrens/page-06.jpg", title: "Page 6" },
      { src: "/portfolio/childrens/page-07.jpg", title: "Page 7" },
      { src: "/portfolio/childrens/page-08.jpg", title: "Page 8" },
      { src: "/portfolio/childrens/page-09.jpg", title: "Page 9" },
      { src: "/portfolio/childrens/page-10.jpg", title: "Page 10" },
      { src: "/portfolio/childrens/page-11.jpg", title: "Page 11" },
      { src: "/portfolio/childrens/page-12.jpg", title: "Page 12" },
      { src: "/portfolio/childrens/page-13.jpg", title: "Page 13" },
      { src: "/portfolio/childrens/page-14.jpg", title: "Page 14" },
      { src: "/portfolio/childrens/page-15.jpg", title: "Page 15" },
      { src: "/portfolio/childrens/page-16.jpg", title: "Page 16" },
      { src: "/portfolio/childrens/page-17.jpg", title: "Page 17" },
      { src: "/portfolio/childrens/page-18.jpg", title: "Page 18" },
      { src: "/portfolio/childrens/page-19.jpg", title: "Page 19" },
      { src: "/portfolio/childrens/page-20.jpg", title: "Page 20" },
      { src: "/portfolio/childrens/page-21.jpg", title: "Page 21" },
      { src: "/portfolio/childrens/page-22.jpg", title: "Page 22" },
      { src: "/portfolio/childrens/page-23.jpg", title: "Page 23" },
      { src: "/portfolio/childrens/page-24.jpg", title: "Page 24" },
      { src: "/portfolio/childrens/page-25.jpg", title: "Page 25" },
      { src: "/portfolio/childrens/page-26.jpg", title: "Page 26" },
      { src: "/portfolio/childrens/page-27.jpg", title: "Page 27" },
      { src: "/portfolio/childrens/page-28.jpg", title: "Page 28" },
      { src: "/portfolio/childrens/page-29.jpg", title: "Page 29" },
      { src: "/portfolio/childrens/page-30.jpg", title: "Page 30" },
      { src: "/portfolio/childrens/page-31.jpg", title: "Page 31" },
      { src: "/portfolio/childrens/page-32.jpg", title: "Page 32" },
      { src: "/portfolio/childrens/back-cover.jpg", title: "Back Cover" },
    ] as CoverImage[],
  },
  paperbackCovers: {
            ...
            <div className={filteredGenres.length > 0 ? "mb-20" : ""}>
              ...
              {portfolioData.map((series, seriesIdx) => (
                <div
                  key={series.id}
                  className={
                    seriesIdx < portfolioData.length - 1 ? "mb-20" : ""
                  }
                >
                  {/* Series header */}
                  <div
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex justify-center">
                      <button
                        ...
                        className="group overflow-hidden rounded-xl border border-border bg-surface-light transition-all hover:border-gold/30 hover:shadow-lg hover:shadow-gold/10 hover:-translate-y-1 w-full max-w-2xl"
                      >
                        <Image
                          src={series.logo.src}
                  ...
                  {/* 3. Box Sets — side by side, natural ratio, no cropping (Aztec only) */}
                  ...
                  {series.characters && series.characters.length > 0 && (
                    <div>
                      <p
                        ...
                        style={{ color: series.accentColor }}
                      >
                        Character Portraits (sample of{" "}
                        {series.characters.length} from 30+)
                      </p>
                      <div className="grid grid-cols-3 gap-3 sm:gap-4 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8">
