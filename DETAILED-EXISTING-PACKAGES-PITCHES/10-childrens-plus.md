...
**Individual page files.** All illustrations delivered separately at print resolution — useful for marketing materials, ARC distribution, or digital editions on secondary platforms.

**Two rounds of revisions.** An extra revision round over Standard — because print is permanent. You want to be certain before you commit to a print run. The second revision cycle exists specifically to give you that certainty.

**Why print matters for children's books specifically:**
...
**Price: $750. 6 business days. A complete 32-page illustrated picture book, print-ready and built to last.**
...
- The author wants a dedicated **character design system** — reference sheets documenting the character from multiple angles and expressions, built before illustration begins. This is included in Premium, not Plus.
- The author's character has significant design complexity (intricate cultural clothing, armor, non-human features) that benefits from a formal design system
- The author mentions wanting the story text as a separate document (for translation, audiobook narration, or adaptation) — included in Premium
- The author is building a series of picture books and needs the character to be reproducible across multiple volumes
